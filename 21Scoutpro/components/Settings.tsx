            ...
            <form onSubmit={handleSubmit} className="bg-black p-8 rounded-3xl border border-zinc-800 shadow-xl space-y-6">
                ...
                <div className="space-y-4 pt-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Passes Corretos</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Passes Errados</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Chutes Fora</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Desarmes com Posse</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Desarmes sem Posse</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Desarmes Contra-Ataque</label>
                        ...
                        <div>
                            <label className="text-[10px] text-zinc-500 font-bold uppercase block mb-1">Erros de Transição</label>
